...
import { DrawingUtils, HandLandmarker, FilesetResolver } from "https://cdn.jsdelivr.net/npm/@mediapipe/tasks-vision@0.10.0";
...
async function predictWebcam() {
    ...
    if (results.landmarks && collectData) {
        for (const landmarks of results.landmarks) {
            console.log(landmarks);

            // Convert the landmarks to an array of numbers
            const convertedLandmarks = convertArray(landmarks);
            console.log(convertedLandmarks);
        ...
        collectData = false; // Reset after collecting data once
    }
    canvasCtx.restore();
